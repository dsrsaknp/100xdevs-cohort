...
const _radius51 = Symbol(); // Note: it's NOT new Symbol()
const _draw = Symbol();

class Circle {
  constructor(radius) {
    this[_radius51] = radius; // private property
  }
  [_draw]() {
    // private method
...
const radius_key = Object.getOwnPropertySymbols(c43)[0]; //  Object.getOwnPropertySymbols returns an array of symbols
console.log(c43[radius_key]);

// accessing symbol prototype property  _draw
const draw_key = Object.getOwnPropertySymbols(Circle.prototype)[0]; // since draw is a prototype property
...
const _radius52 = new WeakMap();
const _move = new WeakMap();

class Circle {
  constructor(radius) {
    _radius52.set(this, radius);
...
const _radius6 = new WeakMap();

class Circle {
  constructor(radius) {
    _radius6.set(this, radius);
  }
  ...
  // writing the above getRadius method using get to access object's property.
  // **In traditional js, this can be done using Object.defineProperty [refer - day_3.js]
  get radius() {
    return _radius.get(this);
  }
