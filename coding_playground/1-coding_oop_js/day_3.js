...
for (let property in gadget1) {
  ...
  // includes prototype properties as well, though non-enumerble (i.e. false when propertyIsEnumerable method is invoked on it.)
}
...
Object.defineProperty(person, "age", {
  configurable: false, // try with true
  value: 12,
});
console.log(person.age);
delete person.age;
console.log(person.age); // didn't get deleted as configurable attribute set to false and undefined if true.

// #4.3
console.log(person.age);
Object.defineProperty(person, "age", {
  configurable: false,
  writable: false, // try with true
  value: 12,
});
delete person.age;
console.log(person.age);
...
person.fullName = "";
console.log(person.fullName); // UNSOLVED MYSTERY 🤔 
